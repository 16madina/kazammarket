          ...
          <div className="space-y-4 text-sm">
            <section>
              ...
              <p className="text-muted-foreground">
                Nous collectons les informations que vous nous fournissez directement lors de votre inscription, notamment votre nom, prénom, email, numéro de téléphone, pays et ville. Ces informations sont nécessaires pour créer et gérer votre compte KAZAM.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                KAZAM n'est pas destiné aux personnes de moins de 18 ans. Nous ne collectons pas sciemment d'informations personnelles auprès de mineurs. Si vous pensez qu'un mineur a fourni des informations personnelles, veuillez nous contacter immédiatement.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                KAZAM peut demander les permissions suivantes :
              </p>
              <ul className="list-disc list-inside text-muted-foreground mt-2 space-y-1">
